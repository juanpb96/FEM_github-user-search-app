    ...
    return (
        <article className='[ profile ] [ bg-secondary card-border ]'>
            <header className='[ profile__header ][ mb-34 ]'>
                <img className='profile__photo' src='./assets/avatar-default.png' alt='User' />
                <h2 
            ...
            <section className='[ details ] [ bg-primary br-10 mb-24 ]'>
                <div>
                    ...
                    <p className='[ title-color fs-medium fw-700 ]'>8</p>
                </div>
                <div>
                    <p className='[ mb-8 fs-xsmall ]'>Followers</p>
                    <p className='[ title-color fs-medium fw-700 ]'>3938</p>
                </div>
                <div>
                    <p className='[ mb-8 fs-xsmall ]'>Following</p>
                    <p className='[ title-color fs-medium fw-700 ]'>9</p>
                </div>
            </section>

            <ul className='[ list ] [ grid-flow ] [ no-bullets ]'>
                <li className='[ list__item ] [ fs-small ]'>
                    <div className='icon'>
                        <svg 
                ...
                <li className='[ list__item ] [ fs-small ]'>
                    ...
                    <svg 
                        xmlns='http://www.w3.org/2000/svg'
                        aria-labelledby='websiteIcon'
                        role='img'
                    >
                        <title id='websiteIcon'>Webpage</title>
                        <g>
                    ...
                    <a href='https://github.blog' className='[ text-color-secondary ]'>https://github.blog</a>
                </li>
                <li className='[ list__item ] [ fs-small ]' datatype='disabled'>
                    <div className='icon'>
                        <svg 
                            xmlns='http://www.w3.org/2000/svg'
                ...
                <li className='[ list__item ] [ fs-small ]'>
                    <div className='icon'>
                        <svg 
                            xmlns='http://www.w3.org/2000/svg' 
                            aria-labelledby='companyIcon'
                            role='img'
                        >
                            <title id='companyIcon'>Company</title>
                            <g>
